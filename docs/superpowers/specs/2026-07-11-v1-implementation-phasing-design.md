...
| D-V1-3 | Spec depth | Full phase map at boundary level; only P1 at implementation grade | Sequencing locked while detail stays accurate (YAGNI); later phases spec against real code |
