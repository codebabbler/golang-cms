...
2. Postgres's own `ACCESS EXCLUSIVE` lock on the altered table queues the DDL behind in-flight DML statements and queues new DML behind the DDL; no write ever sees a half-altered table.
